...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0a0a0a]">
      ...
      {/* HEADER */}
      <header className="w-full h-12 flex items-center justify-center bg-slate-950 border-b border-slate-800 shadow-lg sticky top-0 z-50">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-3xl">
          {NAV_CARDS.map(({ href, label, sub, accent, icon }) => (
            <Link
              key={href}
              href={href}
              className="group relative bg-slate-900/40 border border-slate-800 rounded-2xl p-6 flex flex-col items-center gap-3 text-center hover:border-opacity-60 transition-all duration-300 hover:scale-[1.02] active:scale-95 overflow-hidden"
            ...
            >
              ...
              <span className="font-black italic text-lg tracking-tighter uppercase leading-none text-white">
                {label}
              </span>
